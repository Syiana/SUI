--[[
    SUI 2.0 - Config/Theme.lua

    The look of the options window: dark panels, blue accent, gold headers.
    Unchanged from SUI 1.x on purpose.
]]
...
SUIConfig.IsClientSupported = function(clients)
    return SUI:SupportsClient(clients)
end
