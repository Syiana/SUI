local ADDON, SUI = ...
SUI.MODULES.UNITFRAMES.Boss = function(state) 
    if (state) then
        function SUIBossFrames()
            for i = 1, MAX_BOSS_FRAMES do
    
                    _G["Boss"..i.."TargetFrameHealthBar"]:SetStatusBarTexture("Interface\\Addons\\SUI\\inc\\assets\\media\\unitframes\\UI-StatusBar");
                    _G["Boss"..i.."TargetFrameManaBar"]:SetStatusBarTexture("Interface\\Addons\\SUI\\inc\\assets\\media\\unitframes\\UI-StatusBar");
                ...
                _G["Boss"..i.."TargetFrameTextureFrameTexture"]:SetTexture("Interface\\Addons\\SUI\\inc\\assets\\media\\unitframes\\UI-UNITFRAME-BOSS");
