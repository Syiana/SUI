...
SUI:RegisterDefaults("tooltip", {
    ...
    ids = true,            -- spell, item and NPC id lines
    itemlevel = true,      -- item level of players (Mainline, Mists)
    mythicplus = true,     -- Mythic+ rating of players (Mainline)
    pvprating = false,     -- arena/shuffle rating of players, needs an inspect (Mainline)
    lfgtooltips = true,    -- group finder leader rating and applicant tooltips (Mainline)
})
