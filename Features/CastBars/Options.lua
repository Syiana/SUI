    ...
    rows = function()
        return {
            { header = { type = "header", label = "Castbars" } },
            {
                ...
                texture = { key = "texture", type = "dropdown", label = "Texture", options = textures(), column = 5, order = 2 },
            },
            ...
            {
                targetSize = { key = "targetSize", type = "slider", label = "Target", min = 0.5, max = 3, step = 0.1, precision = 1, column = 4, order = 1 },
                focusSize = { key = "focusSize", type = "slider", label = "Focus Target", min = 0.5, max = 3, step = 0.1, precision = 1, clients = FOCUS, column = 4, order = 2 },
            },
