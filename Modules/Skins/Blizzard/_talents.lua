    ...
    f:SetScript("OnEvent", function(self, event, name)
      if name == "Blizzard_ClassTalentUI" then
        for i, v in pairs({
          ...
          ClassTalentFrame.TalentsTab.BottomEdge, }) do
        ...
        for i, v in pairs({
          ...
          ClassTalentFrameTalentsPvpTalentFrameTalentListScrollFrameScrollBarBottom, }) do
        ...
        for i, v in pairs({
          ...
          ClassTalentFrameBg,
          ClassTalentFrameTalentsPvpTalentFrameTalentListBg }) do
