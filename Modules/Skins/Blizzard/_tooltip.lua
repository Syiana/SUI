...
function Module:OnEnable()
  if (SUI:Color()) then
    ...
    local function macroItemTooltip(self)
        if self:GetTooltipData() and self:GetTooltipData().lines and self:GetTooltipData().lines[2] and self:GetTooltipData().lines[2].leftText and self:GetTooltipData().lines[2].leftColor then
