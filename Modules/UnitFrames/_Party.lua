            ...
            if IsInGroup(player) and (not IsInRaid(player)) and (not useCompact) then
                for i = 1, 4 do
                    if (config.TEXTURES) then
                        _G["PartyMemberFrame"..i.."HealthBar"]:SetStatusBarTexture("Interface\\Addons\\SUI\\Media\\Textures\\unitframes\\UI-StatusBar");
                        _G["PartyMemberFrame"..i.."ManaBar"]:SetStatusBarTexture("Interface\\Addons\\SUI\\Media\\Textures\\unitframes\\UI-StatusBar");
                    end
